...
// Alias for fetchOrderBook to maintain compatibility with components using getOrderBook
export const getOrderBook = fetchOrderBook;
...
// Alias for fetchUserOrders to maintain compatibility with components using getUserOrders
export const getUserOrders = fetchUserOrders;
...
// Alias for fetchRecentTrades to maintain compatibility with components using getRecentTrades
export const getRecentTrades = fetchRecentTrades;
...
// Alias for fetchUserTrades to maintain compatibility
export const getUserTrades = fetchUserTrades;
...
// Alias for fetchContractTrades to maintain compatibility
export const getContractTrades = fetchContractTrades;
